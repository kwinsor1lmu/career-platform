...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], name="fk_experiences_profile_id_profiles"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("start_date", sa.String(length=20), nullable=True),
        sa.Column("end_date", sa.String(length=20), nullable=True),
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], name="fk_educations_profile_id_profiles"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], name="fk_skills_profile_id_profiles"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("start_date", sa.String(length=20), nullable=True),
        sa.Column("end_date", sa.String(length=20), nullable=True),
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], name="fk_certifications_profile_id_profiles"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["profile_id"], ["profiles.id"], name="fk_contact_links_profile_id_profiles"),
        sa.PrimaryKeyConstraint("id"),
